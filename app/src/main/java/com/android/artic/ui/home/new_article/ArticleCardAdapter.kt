...
class ArticleCardAdapter(val ctx: Context, var dataList: List<Article>): RecyclerView.Adapter<ArticleCardAdapter.Holder>(){
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        Glide.with(ctx).load(dataList[position].title_img_url).into(holder.img_background!!)
